...
pub(super) fn helper_lines(helper: Helper) -> Vec<String> {
    ...
    match helper {
        ...
        Helper::Load8x8S => owned(&[
            "fn load8x8_s(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 8 {",
        ...
        Helper::Load8x8U => owned(&[
            "fn load8x8_u(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 8 {",
        ...
        Helper::Load16x4S => owned(&[
            "fn load16x4_s(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 4 {",
        ...
        Helper::Load16x4U => owned(&[
            "fn load16x4_u(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 4 {",
        ...
        Helper::Load32x2S => owned(&[
            "fn load32x2_s(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 2 {",
        ...
        Helper::Load32x2U => owned(&[
            "fn load32x2_u(&self, addr: u32, offset: u32) -> u128 {",
            "    let a = addr as usize + offset as usize;",
            "    let mut r = [0u8; 16];",
            "    let mut i = 0;",
            "    while i < 2 {",
